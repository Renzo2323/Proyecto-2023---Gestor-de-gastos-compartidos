...
export default {
    name: 'formularioAgregarCategoria',
    components: {
        Boton,
        Form,
        Field,
    ...
    methods: {
        async onSubmit(valores) {
            ...
            const response = await axios.post(import.meta.env.VITE_API + "/api/categorias/adm/addGlobal", data, 
                        {headers: {
...
<template>
    ...
    <Form @submit="onSubmit">
        ...
        <Boton :loading="procesando" tipo="primario2" type="submit">Crear categoria</Boton>
